...
class LoginEnView(View):
    def post(self,request):
        ...
        if UserProfile.objects.filter(username=user_name):
            return render(request, 'HTML/EN/login.html',{
                "msg":"The usename is been used, please select an onthe name!"
            })
        userinfor = UserProfile()
        userinfor.username = user_name
        userinfor.password = user_password
...
def PreAddEn(request):
    if request.method == "POST":
        ...
        mode = request.user.id % 4
        PreQuestionResult.objects.create(mode_id=mode,Q1_age=age,Q2_gender=sex,Q3_nationa=national,Q4_educationlevel=edu,Q41_educationlevel=eduother,Q5_expertise=knowledge,Q51_expertise=knowother,Q6_role=role,Q61_role= roleother,Q7_fulltime=years,Q8_ProjectCount=pronu,Q9_DesigCourse=cours, Q10_UsedTechnique=tech,Q11_FamiliarTechnique=samtech,Q12_knewpretty=que1,Q13_experts=que2,Q14_knewless=que3,Q15_donotknow=que4, Q16_donotfeel=que5,Q17_lotofexperiences=que6, Q18_familiar=que7,Q19_focusobjects=que8,Q20_basedcategories=que9,Q21_easylearncategories=que10,Q22_organizefunctionally=que11, Q23_useformallogic=que12,Q24_adherelogicalrules=que13,Q25_individualbehavior=que14,Q26_focussurobj=que15,Q27_focussurfeld=que16,Q28_difflearncate=que17, Q29_organthematically=que18,Q30_diareasoning=que19,Q31_preflogic=que20,Q32_peopbehav=que21,Test_User_id=user_id)
    return render(request, 'HTML/EN/introduction.html', { })
...
def EnTask1(request):
    ...
    taskdes = TaskDes.filter(id=1)
    return render(request, 'HTML/EN/TaskDetail.html',{
        "taskdes":taskdes,
    } )
...
def B_AddTech1EN(request):
    ...
    SelectedTechniqueOne.objects.create(chose_Tech1=selected1,chose_Tech2=selected2, chose_Tech3=selected3,Test_User_id=user_id,mode_id= mode_id )
    return render(request, 'HTML/EN/Blank/post-test 1.html',{ })


# 添加Post-question1到数据库，并跳转到Task-Detail 2页面
def B_AddPost1EN(request):
    if request.method == "POST":
        post1 = request.POST.get('post1')
        post2 = request.POST.get('post2')
        post3 = request.POST.get('post3')
        ...
        TaskDes = TaskDescriptionEN.objects.all()
        taskdes = TaskDes.filter(id=2)
        return render(request, 'HTML/EN/Blank/TaskDetailtwo.html',{
            "taskdes":taskdes,
        })
...
def B_AddTech2EN(request):
    ...
    taskdes = taskdes_all.filter(id=2)
    SelectedTechniqueTwo.objects.create(mode_id=mode,chose_Tech1=selected1,chose_Tech2=selected2, chose_Tech3=selected3,Test_User_id=user_id )
    return render(request, 'HTML/EN/Blank/post-test 2.html',{
        "taskdes":taskdes,
    })


# 添加post-question2 答案到数据库，并跳转到TaskDetail 3页面
def B_AddPost2EN(request):
    if request.method == "POST":
        post1 = request.POST.get('post1')
        post2 = request.POST.get('post2')
        post3 = request.POST.get('post3')
...
def T_AddTech1EN(request):
    ...
    mode = request.user.id % 4
    SelectedTechniqueOne.objects.create(chose_Tech1=selected1,chose_Tech2=selected2, chose_Tech3=selected3,Test_User_id=user_id ,mode_id = mode)
    return render(request, 'HTML/EN/Top-down/post-test 1.html',{
    })


# 添加Post-question1到数据库，并跳转到Task-Detail 2页面
def T_AddPost1EN(request):
    if request.method == "POST":
        post1 = request.POST.get('post1')
        post2 = request.POST.get('post2')
        post3 = request.POST.get('post3')
        ...
        TaskDes = TaskDescriptionEN.objects.all()
        taskdes = TaskDes.filter(id=2)
        return render(request, 'HTML/EN/Top-down/TaskDetailtwo.html',{
            "taskdes":taskdes,
        })
...
def T_AddTech2EN(request):
    ...
    taskdes = taskdes_all.filter(id=2)
    SelectedTechniqueTwo.objects.create(mode_id=mode,chose_Tech1=selected1,chose_Tech2=selected2, chose_Tech3=selected3,Test_User_id=user_id )
    return render(request, 'HTML/EN/Top-down/post-test 2.html', {
        "taskdes":taskdes,
    })


# 添加post-question2 答案到数据库，并跳转到TaskDetail 3页面
def T_AddPost2EN(request):
    if request.method == "POST":
        post1 = request.POST.get('post1')
        post2 = request.POST.get('post2')
        post3 = request.POST.get('post3')
        ...
        TaskDes = TaskDescriptionEN.objects.all()
        taskdes = TaskDes.filter(id=3)
        return render(request, 'HTML/EN/Top-down/TaskDetailthree.html',{
            "taskdes":taskdes,
        })
...
def U_AddTech1EN(request):
    ...
    mode = request.user.id % 4
    SelectedTechniqueOne.objects.create(mode_id=mode,chose_Tech1=selected1,chose_Tech2=selected2, chose_Tech3=selected3,Test_User_id=user_id )
    return render(request, 'HTML/EN/Bottom-up/post-test 1.html',{
    })


# 添加Post-question1到数据库，并跳转到Task-Detail 2页面
def U_AddPost1EN(request):
    if request.method == "POST":
        post1 = request.POST.get('post1')
        post2 = request.POST.get('post2')
        post3 = request.POST.get('post3')
        ...
        TaskDes = TaskDescriptionEN.objects.all()
        taskdes = TaskDes.filter(id=2)
        return render(request, 'HTML/EN/Bottom-up/TaskDetailtwo.html',{
            "taskdes":taskdes,
        })
...
def U_AddTech2EN(request):
    ...
    taskdes = taskdes_all.filter(id=2)
    SelectedTechniqueOne.objects.create(mode_id=mode,chose_Tech1=selected1,chose_Tech2=selected2, chose_Tech3=selected3,Test_User_id=user_id )
    return render(request, 'HTML/EN/Bottom-up/post-test 2.html',{
        "taskdes":taskdes,
    })


# 添加post-question2 答案到数据库，并跳转到TaskDetail 3页面
def U_AddPost2EN(request):
    if request.method == "POST":
        post1 = request.POST.get('post1')
        post2 = request.POST.get('post2')
        post3 = request.POST.get('post3')
        ...
        TaskDes = TaskDescriptionEN.objects.all()
        taskdes = TaskDes.filter(id=3)
        return render(request, 'HTML/EN/Bottom-up/TaskDetailthree.html',{
            "taskdes":taskdes,
        })
...
def C_AddTech1EN(request):
    ...
    mode = request.user.id % 4
    SelectedTechniqueOne.objects.create(mode_id=mode,chose_Tech1=selected1,chose_Tech2=selected2, chose_Tech3=selected3,Test_User_id=user_id )
    return render(request, 'HTML/EN/Tag-Cloud/post-test 1.html',{
    })


# 添加Post-question1到数据库，并跳转到Task-Detail 2页面
def C_AddPost1EN(request):
    if request.method == "POST":
        post1 = request.POST.get('post1')
        post2 = request.POST.get('post2')
        post3 = request.POST.get('post3')
        ...
        TaskDes = TaskDescriptionEN.objects.all()
        taskdes = TaskDes.filter(id=2)
        return render(request, 'HTML/EN/Tag-Cloud/TaskDetailtwo.html',{
            "taskdes":taskdes,
        })
...
def C_AddTech2EN(request):
    ...
    taskdes = taskdes_all.filter(id=2)
    SelectedTechniqueOne.objects.create(mode_id=mode,chose_Tech1=selected1,chose_Tech2=selected2, chose_Tech3=selected3,Test_User_id=user_id )
    return render(request, 'HTML/EN/Tag-Cloud/post-test 2.html', {
        "taskdes":taskdes,
    })


# 添加post-question2 答案到数据库，并跳转到TaskDetail 3页面
def C_AddPost2EN(request):
    if request.method == "POST":
        post1 = request.POST.get('post1')
        post2 = request.POST.get('post2')
        post3 = request.POST.get('post3')
        ...
        TaskDes = TaskDescriptionEN.objects.all()
        taskdes = TaskDes.filter(id=3)
        return render(request, 'HTML/EN/Tag-Cloud/TaskDetailthree.html',{
            "taskdes":taskdes,
        })
